...
% PREAMBLE
% ============================================================
\documentclass[twoside,openany,a4paper,11pt,english]{report}
...
% ---- Fonts: Palatino (body) + Helvetica (sans) + Courier (mono) ----
% Palatino is one of the most respected serif fonts in academia
\usepackage{mathpazo}
\usepackage[scaled]{helvet}
\usepackage{courier}

% ---- Colors (define once, use sparingly) ----
\usepackage{color}
\usepackage{xcolor}
\definecolor{unistraBlue}{RGB}{0, 62, 115}
% Link box colors (arXiv style)
...
% ---- Bibliography: natbib numbered ----
\usepackage[numbers]{natbib}

% ---- Hyperlinks: arXiv-style colored boxes ----
\usepackage{hyperref}
\urlstyle{sf}
\hypersetup{
    colorlinks=false,            % Text stays black
    citebordercolor=citegreen,   % Citations [1]: light green box
    linkbordercolor=linkred,     % Sections, figures: red box
    urlbordercolor=urlcyan,      % URLs: cyan box
    pdfborderstyle={/S/U/W 1},   % Thin underline-style border
}

% ---- Blank page helper: emits exactly one visible empty page.
%      Works cleanly with openany (no automatic blanks to collide with).
\newcommand{\blankpage}{%
    \clearpage
    \thispagestyle{empty}%
    \null
...
% Front matter: cover, license, ToC use roman numerals
\pagenumbering{roman}
...
% ---- Program info ----
{\large\textsc{Master in Computer Science --- CODIA Track}\\[2pt]
\textsc{\large Knowledge, Data Science and Artificial Intelligence}}

\vspace{0.5cm}

% ---- Separator (top) ----
{\color{unistraBlue}\rule{0.5\textwidth}{0.8pt}}

\vspace{0.3cm}

% ---- Document type ----
{\Large Research Study Project (TER)}

\vspace{1.8cm}

% ---- TITLE ----
{\fontsize{22}{28}\selectfont\bfseries Quantum Computing for Machine Learning}

\vspace{0.4cm}

{\Large\itshape Network Traffic Classification \& Zero-Day Attack Detection}

\vspace{1.8cm}

% ---- Author ----
{\Large\bfseries Ashkan \textsc{Motamedifar}}

\vspace{1.2cm}

% ---- Supervisor ----
{\small Supervised by}\\[4pt]
{\normalsize Fabrice \textsc{Th\'{e}oleyre}}

\vspace{2.5cm}

% ---- Bottom: Logos row (vertically centered on a shared baseline) ----
\raisebox{-0.5\height}{\includegraphics[height=1.4cm]{logos/LOGO_CNRS_BLEU.png}}\hspace{1.0cm}%
\raisebox{-0.5\height}{\includegraphics[height=1.0cm]{logos/icube.pdf}}

\vspace{0.5cm}

% ---- Institution and date ----
{\small Laboratoire ICube -- UMR 7357\\
Universit\'{e} de Strasbourg $\cdot$ CNRS}

\vspace{0.3cm}

{\normalsize Strasbourg --- May 2026}
...
% Main body: switch to arabic numerals starting at 1
\clearpage
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Chapter 2: Quantum Computing Foundations
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\input{chapters/02_quantum_foundations}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Chapter 3: Quantum ML Architectures
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\input{chapters/03_quantum_ml_architectures}
...
\section*{Note on Writing Assistance}

Parts of the text in this report were refined with the assistance of a large language model (LLM) for language formulation and proofreading. All scientific content---including the problem formulation, dataset preprocessing, model design, experiments, analyses, figures, and conclusions---is my own.
...
% Make the bibliography a numbered appendix chapter
